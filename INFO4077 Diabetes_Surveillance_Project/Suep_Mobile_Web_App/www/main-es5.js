(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-app>\n  <ion-split-pane contentId=\"main-content\">\n    <ion-menu [disabled]=\"afficheMenu\" contentId=\"main-content\" type=\"overlay\">\n      <ion-content>\n        <ion-list id=\"inbox-list\">\n          <ion-list-header>Suep</ion-list-header>\n          <ion-note>Diabète</ion-note>\n\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages; let i = index\">\n            <ion-item (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n              <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n              <ion-label>{{ p.title }}</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n\n        <ion-list id=\"labels-list\">\n          <ion-list-header>Suep © 2020</ion-list-header>\n        </ion-list>\n\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n";
      /***/
    },
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_redirect_guard_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./services/redirect-guard.service */
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~folder-folder-module~pages-presentation-statistique-statistique-module"), __webpack_require__.e("default~folder-folder-module~pages-patients-apercu-apercu-module"), __webpack_require__.e("default~folder-folder-module~pages-patients-add-patient-add-patient-module"), __webpack_require__.e("folder-folder-module")]).then(__webpack_require__.bind(null,
        ...
        path: 'home',
        canActivate: [_services_redirect_guard_service__WEBPACK_IMPORTED_MODULE_4__["RedirectGuardService"]],
        loadChildren: function loadChildren() {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | pages-patients-add-patient-add-patient-module */
          [__webpack_require__.e("default~folder-folder-module~pages-patients-add-patient-add-patient-module"), __webpack_require__.e("pages-patients-add-patient-add-patient-module")]).then(__webpack_require__.bind(null,
          /*! ./pages/patients/add-patient/add-patient.module */
          "./src/app/pages/patients/add-patient/add-patient.module.ts")).then(function (m) {
            return m.AddPatientPageModule;
          });
        }
      }, {
        path: 'apercu',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | pages-patients-apercu-apercu-module */
          [__webpack_require__.e("default~folder-folder-module~pages-patients-apercu-apercu-module"), __webpack_require__.e("pages-patients-apercu-apercu-module")]).then(__webpack_require__.bind(null,
          /*! ./pages/patients/apercu/apercu.module */
          "./src/app/pages/patients/apercu/apercu.module.ts")).then(function (m) {
            return m.ApercuPageModule;
          });
        }
      }, {
        path: 'statistique',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | pages-presentation-statistique-statistique-module */
          [__webpack_require__.e("default~folder-folder-module~pages-presentation-statistique-statistique-module"), __webpack_require__.e("pages-presentation-statistique-statistique-module")]).then(__webpack_require__.bind(null,
          /*! ./pages/presentation/statistique/statistique.module */
          "./src/app/pages/presentation/statistique/statistique.module.ts")).then(function (m) {
            return m.StatistiquePageModule;
          });
        }
      }];
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, splashScreen, statusBar) {
          ...
          this.noConnect = ['home', 'connexion', 'inscription'];
          this.initializeApp();
        }
        ...
        _createClass(AppComponent, [{
          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              ...
              firebase__WEBPACK_IMPORTED_MODULE_5__["default"].initializeApp(firebaseConfig); // Activation de la persistance de donnée

              firebase__WEBPACK_IMPORTED_MODULE_5__["default"].firestore().enablePersistence();

              if (!_this.noConnect.includes(window.location.href.split('/')[window.location.href.split('/').length - 1])) {
                _this.afficheMenu = false;
              }
        ...
        _createClass(AuthGuard, [{
          ...
          value: function canActivate(route, state) {
            ...
            return new Promise(function (resolve, reject) {
              _this2.authService.isAuthenticated().then(function (docRef) {
                if (docRef === false) _this2.router.navigate(['/home']);
                resolve(docRef);
              });
            });
          }
    ...
    function srcAppServicesAuthentificationServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthentificationService = /*#__PURE__*/function () {
        ...
        _createClass(AuthentificationService, [{
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      return _context.abrupt("return", new Promise(function (resolve, reject) {
                        firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().onAuthStateChanged(function (user) {
                          if (user) {
                            resolve(true);
                          } else {
                            resolve(false);
          ...
          key: "signUpUser",
          value: function signUpUser(name, surname, adresseEmail, phone, motDePasse) {
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      return _context2.abrupt("return", new Promise(function (resolve, reject) {
                        firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().createUserWithEmailAndPassword(adresseEmail, motDePasse).then(function () {
                          // tslint:disable-next-line:max-line-length
                          firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('comptes').doc(adresseEmail).set({
                            nom: name,
                            prenom: surname,
                            email: adresseEmail,
                            telephone: phone,
                  ...
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      return _context3.abrupt("return", new Promise(function (resolve, reject) {
                        firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().sendPasswordResetEmail(email).then(function () {
                          resolve();
                        }, function (error) {
                          reject(error);
                        });
          ...
          value: function signInUser(email, password) {
            return new Promise(function (resolve, reject) {
              firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().signInWithEmailAndPassword(email, password).then(function () {
                resolve();
              }, function (error) {
                reject(error);
              });
                  ...
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      return _context4.abrupt("return", new Promise(function (resolve, reject) {
                        firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().signOut().then(function () {
                          resolve();
                        }, function (error) {
                          reject(error);
                        });
    ...
    /***/
    function srcAppServicesRedirectGuardServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RedirectGuardService", function () {
      ...
      var RedirectGuardService = /*#__PURE__*/function () {
        function RedirectGuardService(authService, router) {
          _classCallCheck(this, RedirectGuardService);

          this.authService = authService;
          this.router = router;
        }

        _createClass(RedirectGuardService, [{
          key: "canActivate",
          value: function canActivate(route, state) {
            var _this3 = this;

            return new Promise(function (resolve, reject) {
              _this3.authService.isAuthenticated().then(function (docRef) {
                if (docRef === true) {
                  _this3.router.navigate(['/folder']);
                }
      ...
      RedirectGuardService.ctorParameters = function () {
        return [{
      ...
      RedirectGuardService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\SEFFI PEGUY\Documents\Projet ionic\projet-suep\src\main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
