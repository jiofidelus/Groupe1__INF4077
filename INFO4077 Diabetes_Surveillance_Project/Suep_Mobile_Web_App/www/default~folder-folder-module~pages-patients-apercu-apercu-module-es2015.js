...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Symptome", function() { return Symptome; });
class Symptome {
    constructor(idPatient, texte, voice) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApercuPage", function() { return ApercuPage; });
...
/* harmony import */ var _services_symptome_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/symptome.service */ "./src/app/services/symptome.service.ts");
/* harmony import */ var _models_symptome__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../models/symptome */ "./src/app/models/symptome.ts");
...
/* harmony import */ var recordrtc__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! recordrtc */ "./node_modules/recordrtc/RecordRTC.js");
...
let ApercuPage = class ApercuPage {
    constructor(apiService, domSanitizer, alertService, symptomeService, alertController, navParams, modalCtrl) {
    ...
    ngOnInit() {
        firebase__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collection('patients').doc(this.navParams.get('id')).onSnapshot((docRef) => {
            this.patient = docRef.data();
            this.patient.id = docRef.id;
            firebase__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collection('symptomes').where('idPatient', '==', this.navParams.get('id')).onSnapshot((docRef1) => {
                this.symptomes = [];
                const appel = this;
    ...
    successCallback(stream) {
        ...
        const StereoAudioRecorder = recordrtc__WEBPACK_IMPORTED_MODULE_7__["StereoAudioRecorder"];
    ...
    sendToServer(blob) {
        ...
        reader.onloadend = function () {
            ...
            appel.apiService.addRecordForAdresseId('PEGUY', 'symptomes/' + appel.patient.email + '/' + Math.floor(Math.random() * (99999 - 10001 + 1)) + 10000, base64data.toString()).then((docRef) => {
                const sympt = new _models_symptome__WEBPACK_IMPORTED_MODULE_5__["Symptome"](appel.patient.id, '', docRef);
    ...
    delPatient() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.isLoading = true;
            firebase__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collection('patients').doc(this.navParams.get('id')).delete().then(() => {
                this.dismissModal();
    ...
    delSymptome(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.isLoading = true;
            firebase__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collection('symptomes').doc(id).delete().then(() => {
                this.isLoading = false;
                ...
                buttons: [
                    {
                        ...
                        handler: (data) => {
                            this.isLoading = true;
                            return new Promise(() => {
                                this.symptomeService.AjouterSymptome(new _models_symptome__WEBPACK_IMPORTED_MODULE_5__["Symptome"](this.navParams.get('id'), data.symptome, '')).then(() => {
...
ApercuPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-apercu',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./apercu.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/patients/apercu/apercu.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./apercu.page.scss */ "./src/app/pages/patients/apercu/apercu.page.scss")).default]
    })
], ApercuPage);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SymptomeService", function() { return SymptomeService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! firebase */ "./node_modules/firebase/dist/index.esm.js");
...
let SymptomeService = class SymptomeService {
    constructor() { }
    AjouterSymptome(symp) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('symptomes').doc().set(Object.assign({}, symp)).then(() => {
                    resolve();
                }, (error) => {
                    reject(error);
                });
...
SymptomeService.ctorParameters = () => [];
SymptomeService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], SymptomeService);
...
//# sourceMappingURL=default~folder-folder-module~pages-patients-apercu-apercu-module-es2015.js.map