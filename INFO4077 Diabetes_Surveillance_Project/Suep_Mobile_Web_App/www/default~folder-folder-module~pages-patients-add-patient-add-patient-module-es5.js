(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~folder-folder-module~pages-patients-add-patient-add-patient-module"], {
    /***/
    ...
    /***/
    "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/patients/add-patient/add-patient.page.html":
    /*!********************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/patients/add-patient/add-patient.page.html ***!
      \********************************************************************************************************/
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesPatientsAddPatientAddPatientPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppModelsPatientTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var Patient = function Patient(nom, prenom, email, telephone, sexe, medecin, description, photo, position) {
    ...
    /***/
    "./src/app/pages/patients/add-patient/add-patient.page.scss":
    /*!******************************************************************!*\
      !*** ./src/app/pages/patients/add-patient/add-patient.page.scss ***!
      \******************************************************************/
    ...
    /***/
    function srcAppPagesPatientsAddPatientAddPatientPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3BhdGllbnRzL2FkZC1wYXRpZW50L2FkZC1wYXRpZW50LnBhZ2Uuc2NzcyJ9 */";
      /***/
    },
    ...
    /***/
    function srcAppPagesPatientsAddPatientAddPatientPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _models_patient__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../../models/patient */
      "./src/app/models/patient.ts");
      /* harmony import */
      ...
      var AddPatientPage = /*#__PURE__*/function () {
        function AddPatientPage(sanitizer, apiService, modalCtrl, formBuilder, patientService, alertService) {
          ...
          this.patientForm = this.formBuilder.group({
            ...
            sexe: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].required],
            longitude: [''],
            latitude: [''],
            description: ['']
          });
        ...
        _createClass(AddPatientPage, [{
          ...
          value: function addPatient() {
            ...
            this.isLoading = true;
            this.apiService.addImageForAdresseId('PEGUY', 'comptes/' + this.patientForm.value.email + '/profil', this.photoIsUpdate ? this.photo.toString() : '').then(function (docRef) {
              var patient = new _models_patient__WEBPACK_IMPORTED_MODULE_4__["Patient"](_this2.patientForm.value.nom, _this2.patientForm.value.prenom, _this2.patientForm.value.email, _this2.patientForm.value.phone, _this2.patientForm.value.sexe, firebase__WEBPACK_IMPORTED_MODULE_6__["default"].auth().currentUser.email, _this2.patientForm.value.description, docRef, {
                latitude: _this2.coordonnee.coords.latitude,
                longitude: _this2.coordonnee.coords.latitude
              });

              _this2.patientService.AjouterPatient(patient).then(function () {
                _this2.alertService.print('Le patient à été ajouté', 'dark');

                _this2.dismissModal();
              }, function (error) {
                _this2.alertService.print('Une erreur est survenue, veuillez reesayer', 'danger');
              ...
              _this2.alertService.print('Une erreur est survenue lors de l\'opération, veillez reesayer', 'danger');
            });
          }
        }, {
          key: "oldPicture",
          value: function oldPicture() {
            this.photo = '';
            this.photoIsUpdate = false;
          }
        }, {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      this.coordonnee = _context2.sent;
      ...
      AddPatientPage.ctorParameters = function () {
        return [{
      ...
      AddPatientPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-patient',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./add-patient.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/patients/add-patient/add-patient.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./add-patient.page.scss */
        "./src/app/pages/patients/add-patient/add-patient.page.scss"))["default"]]
      })], AddPatientPage);
      /***/
    },
    ...
    function srcAppServicesPatientServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PatientService = /*#__PURE__*/function () {
        ...
        _createClass(PatientService, [{
          key: "AjouterPatient",
          value: function AjouterPatient(pat) {
                  ...
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      return _context3.abrupt("return", new Promise(function (resolve, reject) {
                        firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('patients').doc().set(Object.assign({}, pat)).then(function (docRef) {
                          resolve();
                        }, function (error) {
                          reject(error);
                        });
...
//# sourceMappingURL=default~folder-folder-module~pages-patients-add-patient-add-patient-module-es5.js.map