...
class Patient {
    constructor(nom, prenom, email, telephone, sexe, medecin, description, photo, position) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
...
/* harmony import */ var _models_patient__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../models/patient */ "./src/app/models/patient.ts");
...
let AddPatientPage = class AddPatientPage {
    constructor(sanitizer, apiService, modalCtrl, formBuilder, patientService, alertService) {
    ...
    addPatient() {
        this.isLoading = true;
        this.apiService.addImageForAdresseId('PEGUY', 'comptes/' + this.patientForm.value.email + '/profil', this.photoIsUpdate ? this.photo.toString() : '').then((docRef) => {
            const patient = new _models_patient__WEBPACK_IMPORTED_MODULE_4__["Patient"](this.patientForm.value.nom, this.patientForm.value.prenom, this.patientForm.value.email, this.patientForm.value.phone, this.patientForm.value.sexe, firebase__WEBPACK_IMPORTED_MODULE_6__["default"].auth().currentUser.email, this.patientForm.value.description, docRef, { latitude: this.coordonnee.coords.latitude, longitude: this.coordonnee.coords.latitude });
    ...
    getCurrentPosition() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.coordonnee = yield Geolocation.getCurrentPosition();
        });
    }
    watchPosition() {
...
AddPatientPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-patient',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./add-patient.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/patients/add-patient/add-patient.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./add-patient.page.scss */ "./src/app/pages/patients/add-patient/add-patient.page.scss")).default]
    })
], AddPatientPage);
    ...
    AjouterPatient(pat) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('patients').doc().set(Object.assign({}, pat)).then((docRef) => {
                    resolve();
                }, (error) => {
                    reject(error);
                });
...
//# sourceMappingURL=default~folder-folder-module~pages-patients-add-patient-add-patient-module-es2015.js.map