...
/* harmony import */ var _services_redirect_guard_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/redirect-guard.service */ "./src/app/services/redirect-guard.service.ts");
...
const routes = [
    ...
    },
    {
        path: 'folder',
        canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | folder-folder-module */[__webpack_require__.e("default~folder-folder-module~pages-presentation-statistique-statistique-module"), __webpack_require__.e("default~folder-folder-module~pages-patients-apercu-apercu-module"), __webpack_require__.e("default~folder-folder-module~pages-patients-add-patient-add-patient-module"), __webpack_require__.e("folder-folder-module")]).then(__webpack_require__.bind(null, /*! ./folder/folder.module */ "./src/app/folder/folder.module.ts")).then(m => m.FolderPageModule)
    },
    {
        path: 'folder/:id',
        canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
    ...
    {
        path: 'add-patient',
        loadChildren: () => Promise.all(/*! import() | pages-patients-add-patient-add-patient-module */[__webpack_require__.e("default~folder-folder-module~pages-patients-add-patient-add-patient-module"), __webpack_require__.e("pages-patients-add-patient-add-patient-module")]).then(__webpack_require__.bind(null, /*! ./pages/patients/add-patient/add-patient.module */ "./src/app/pages/patients/add-patient/add-patient.module.ts")).then(m => m.AddPatientPageModule)
    },
    {
        path: 'apercu',
        loadChildren: () => Promise.all(/*! import() | pages-patients-apercu-apercu-module */[__webpack_require__.e("default~folder-folder-module~pages-patients-apercu-apercu-module"), __webpack_require__.e("pages-patients-apercu-apercu-module")]).then(__webpack_require__.bind(null, /*! ./pages/patients/apercu/apercu.module */ "./src/app/pages/patients/apercu/apercu.module.ts")).then(m => m.ApercuPageModule)
    },
    {
        path: 'statistique',
        loadChildren: () => Promise.all(/*! import() | pages-presentation-statistique-statistique-module */[__webpack_require__.e("default~folder-folder-module~pages-presentation-statistique-statistique-module"), __webpack_require__.e("pages-presentation-statistique-statistique-module")]).then(__webpack_require__.bind(null, /*! ./pages/presentation/statistique/statistique.module */ "./src/app/pages/presentation/statistique/statistique.module.ts")).then(m => m.StatistiquePageModule)
    }
];
...
let AppComponent = class AppComponent {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            if (!this.noConnect.includes(window.location.href.split('/')[window.location.href.split('/').length - 1])) {
...
let AuthGuard = class AuthGuard {
    ...
    canActivate(route, state) {
        return new Promise((resolve, reject) => {
            this.authService.isAuthenticated().then((docRef) => {
                if (docRef === false)
...
let AuthentificationService = class AuthentificationService {
    ...
    signUpUser(name, surname, adresseEmail, phone, motDePasse) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().createUserWithEmailAndPassword(adresseEmail, motDePasse).then(() => {
                    // tslint:disable-next-line:max-line-length
                    firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('comptes').doc(adresseEmail).set({ nom: name, prenom: surname, email: adresseEmail, telephone: phone, password: motDePasse }).then(() => {
                        resolve();
                    }, (error) => {
                        reject(error);
                    });
    ...
    resetPassword(email) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().sendPasswordResetEmail(email).then(() => {
                    resolve();
                }, (error) => {
                    reject(error);
                });
    ...
    signInUser(email, password) {
        return new Promise((resolve, reject) => {
            firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().signInWithEmailAndPassword(email, password).then(() => {
                resolve();
            }, (error) => {
                reject(error);
            });
...
let RedirectGuardService = class RedirectGuardService {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
...
RedirectGuardService.ctorParameters = () => [
    { type: _authentification_service__WEBPACK_IMPORTED_MODULE_2__["AuthentificationService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
RedirectGuardService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
module.exports = __webpack_require__(/*! C:\Users\SEFFI PEGUY\Documents\Projet ionic\projet-suep\src\main.ts */"./src/main.ts");
